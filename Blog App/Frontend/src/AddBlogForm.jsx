    ...
    <div className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white text-sm py-4 dark:bg-gray-800">
      <form className="max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" onSubmit={handleSubmit} aria-label="Global">
        ...
        <input 
          ...
          className="mt-1 mb-5 px-2 py-1 border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:focus:ring-gray-600" 
          type="text" 
          id="title" 
          name="title" 
        />
